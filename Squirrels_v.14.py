...
search_energy_peanut = np.linspace(1, 1, num=50)
search_energy_hazel = np.linspace(4, 4, num=50)
handle_energy_peanut = np.linspace(2, 2, num=50)
handle_energy_hazel = np.linspace(1, 1, num=50)
x_axis = gain_peanut
...
# Outer while loop
continue_modifying = True
modified_variables = 0

while continue_modifying:
    var_choice = input("Enter '1' for energy gain, '2' for search time, "
    ...
    if var_choice == '3':
        ...
        if nut_choice == 'p':
            ...
            print("Handling time ranges between {} and {} seconds".format(min_handle_time_peanut,
                                                                          max_handle_time_peanut))
    ...
    if var_choice == '4':
        ...
        if nut_choice == 'p':
            ...
            search_energy_peanut = np.linspace(min_search_energy_peanut, max_search_energy_peanut, num=50)
        ...
        if nut_choice == 'h':
            ...
            search_energy_hazel = np.linspace(min_search_energy_hazel, max_search_energy_hazel, num=50)
    ...
    if var_choice == '5':
        ...
        if nut_choice == 'p':
            ...
            handle_energy_peanut = np.linspace(min_handle_energy_peanut, max_handle_energy_peanut, num=50)
        ...
        if nut_choice == 'h':
            ...
            handle_energy_hazel = np.linspace(min_handle_energy_hazel, max_handle_energy_hazel, num=50)
            x_axis = handle_energy_hazel
            var_label = "Handling energy"

    modified_variables += 1
    if modified_variables == 1:
        ...
        hazel_output = currencies(gain_hazel, search_energy_hazel, handle_energy_hazel, search_time_hazel,
                                  handle_time_hazel)
    ...
    if modified_variables == 2:
        continue_modifying = False  # Ensure that only two variables can be changed at a time
