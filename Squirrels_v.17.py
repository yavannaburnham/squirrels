...
search_energy_peanut = (1 * search_time_peanut)
search_energy_hazel = (1 * search_time_hazel)
handle_energy_peanut = (1 * handle_time_peanut)
handle_energy_hazel = (1 * handle_time_hazel)
x_axis = gain_peanut
...
var_choice_1 = input("First variable: enter '1' for energy gain, '2' for search time, "
                     "'3' for handling time, '4' for search energy, or '5' for handling energy: ")
if var_choice_1 == '1':
...
if var_choice_1 == '4':
    ...
    if nut_choice == 'p':
        search_energy_peanut_user = float(input("Enter the amount of calories a squirrel expends"
                                                " per second of search time for a peanut (Kcal / s): "))
        search_energy_peanut = search_energy_peanut_user * search_time_peanut
        x_axis = search_energy_peanut
        var_label = "Search energy"

    if nut_choice == 'h':
        search_energy_hazel_user = float(input("Enter the amount of calories a squirrel expends"
                                               " per second of search time for a hazelnut (Kcal / s): "))
        search_energy_hazel = search_energy_hazel_user * search_time_hazel
...
if var_choice_1 == '5':
    ...
    if nut_choice == 'p':
        handle_energy_peanut_user = float(input("Enter the amount of calories a squirrel expends"
                                                " per second of handling time for a peanut (Kcal / s): "))
        handle_energy_peanut = handle_energy_peanut_user * handle_time_peanut
        x_axis = handle_energy_peanut
        var_label = "Handling energy"

    if nut_choice == 'h':
        handle_energy_hazel_user = float(input("Enter the amount of calories a squirrel expends"
                                               " per second of handling time for a hazelnut (Kcal / s): "))
        handle_energy_hazel = handle_energy_hazel_user * handle_time_hazel
